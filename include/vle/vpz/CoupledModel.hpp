...
public:
    ...
    void addOutputConnection(BaseModel* src,
                             const std::string& portSrc,
                             const std::string& portDst);

    void addInternalConnection(BaseModel* src,
                               const std::string& portSrc,
                               BaseModel* dst,
                               const std::string& portDst);
    ...
    void delInputConnection(const std::string& portSrc,
                            BaseModel* dst,
                            const std::string& portDst);
    void delOutputConnection(BaseModel* src,
                             const std::string& portSrc,
                             const std::string& portDst);
    void delInternalConnection(BaseModel* src,
                               const std::string& portSrc,
                               BaseModel* dst,
                               const std::string& portDst);
    void delInputConnection(const std::string& portSrc,
     ...
     *
     */
    ModelConnections saveInputConnections(ModelList& models);
     ...
     *
     */
    ModelConnections saveOutputConnections(ModelList& models);
    ...
    /**
     * @brief A functor to easily updateDynamics of ModelList::value_type. Use
     * it with
     * std::for_each.
     */
    ...
    /**
     * @brief A functor to easily purgeDynamics of ModelList::value_type. Use
     * it with
     * std::for_each.
     */
    ...
    /**
     * @brief A functor to easily updateObservable of ModelList::value_type.
     * Use it with
     * std::for_each.
     */
    ...
    /**
     * @brief A functor to easily purgeObservable of ModelList::value_type. Use
     * it with
     * std::for_each.
     */
    ...
    /**
     * @brief A functor to easily updateConditions of ModelList::value_type.
     * Use it with
     * std::for_each.
     */
    ...
    /**
     * @brief A functor to easily purgeConditions of ModelList::value_type. Use
     * it with
     * std::for_each.
     */
    ...
    struct IsInModelList
    {
        ...
        {
            return value.second->x() <= x and
                   x <= value.second->x() + value.second->width() and
                   value.second->y() <= y and
    ...
    struct CloneModel
    {
        ...
        {
            x.second = x.second->clone();
            x.second->setParent(parent);
        }
    };
...
private:
     ...
     */
    void copyInternalPort(const ModelPortList& src,
                          ModelPortList& dst,
                          const BaseModel& parentSrc,
                          BaseModel& parentDst);
